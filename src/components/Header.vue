<template>
  <div class="z-50 grid grid-cols-2 ml-3 font-light md:grid-cols-3 font-dosis">
    ...
    <div class="flex flex-col items-center justify-center h-full">
      <h1 class="text-3xl font-thin text-gray-400 transition duration-700 ease-in-out sm:text-5xl dark:text-gray-200">
        TA<span class="font-medium text-gray-800 dark:text-gray-400"
    ...
    <div class="z-50 flex items-center justify-center h-full col-span-2 mt-5 md:col-span-1 md:mt-0">
      ...
      <div class="grid grid-cols-6 gap-x-6 gap-y-1">
        ...
        <a
          href="https://www.linkedin.com/in/tarikkavaz"
          target="_blank"
          class="has-tooltip"
        >
          <span class="tooltip"
        ...
        <a
          href="https://twitter.com/tarikkavaz"
          target="_blank"
          class="has-tooltip"
        >
          <span class="tooltip"
        ...
        <a
          href="https://www.instagram.com/tarikkavaz_/"
          target="_blank"
          class="has-tooltip"
        >
          <span class="tooltip"
        ...
        <a href="https://open.spotify.com/user/tarikkavaz" class="has-tooltip">
          <span class="tooltip"
            ><div class="tool-arrow"></div>
            Spotify</span
          >
