  ...
  <div class="z-50 grid grid-cols-2 ml-3 font-light md:grid-cols-3 font-dosis">
    ...
    <div class="z-50 flex items-center justify-center h-full col-span-2 mt-5 md:col-span-1 md:mt-0">
      ...
      <div class="grid grid-cols-6 gap-x-6 gap-y-1">
        ...
        <ButtonWithTooltip link="mailto:hello@tarikkavaz.com" tooptip="hello@tarikkavaz.com"> 
          <svg
            aria-hidden="true"
            class="icon"
        ...
        <ButtonWithTooltip link="https://github.com/tarikkavaz" tooptip="GitHub"> 
          <svg
            aria-hidden="true"
            class="icon"
            role="img"
        ...
        <ButtonWithTooltip link="https://www.linkedin.com/in/tarikkavaz" tooptip="Linkedin"> 
          <svg
            aria-hidden="true"
            class="icon"
            role="img"
        ...
        <ButtonWithTooltip link="https://open.spotify.com/user/tarikkavaz" tooptip="Spotify"> 
          <svg
            aria-hidden="true"
            class="icon"
            role="img"
