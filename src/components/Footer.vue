<template>
  <div class="container fixed z-50 flex flex-row justify-center bottom-3 md:-translate-x-1/2 md:left-1/2">
      <ButtonWithTooltip location="left" link="https://tailwindcss.com/" linkTarget="_blank" tooptip="TailwindCSS"> 
      ...
      <ButtonWithTooltip location="right" link="https://vuejs.org/" linkTarget="_blank" tooptip="Vue.js"> 
        <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 70 70">
